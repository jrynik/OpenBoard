...
"sk": {
		...
		"blue": "modrá",
		"white": "biela",
		"widgetOptions": "Možnosti aplikácie",
		"widgetTheme": "Pozadie aplikácie",
		"resetWidget": "Obnoviť aplikáciu",
		"checkForUpdate": "Skontrolovať aktualizácie",
		"widgetDevelopedBy": "Aplikáciu vytvoril",
		"widgetContactInfo": "Ak chcete nahlásiť chybu, máte nejaký nápad alebo sa chcete len niečo opýtať ohľadom aplikácie, môžete mi napísať na tento e-mail",
		"widgetBackgroundSource": "Obrázky na pozadí boli prevzaté z prostredia pracovnej plochy KDE",
		"changelogButton": "Prehľad o vylepšeniach",
		"changelogTitle": "Notes de version",
		"displayParameters": "Prehľad o vylepšeniach",
		"functionsParameters": "Parametre funkcií",
		"plotRange": "Rozsah zobrazenia",
		"xAxis": "os X",
		"yAxis": "os Y",
		"to": "do",
		"defaultZoom": "Predvolené priblíženie",
		"defaultDisplayParameters": "Predvolené parametre zobrazenia",
		"displayMethod": "Spôsob zobrazenia",
		"showGrid": "zobraziť mriežku",
		"showAxis": "zobraziť súradnicové osi",
		"showScale": "zobraziť číselnú os",
		"graphAccuracy": "Presnosť grafu, počet vypočítaných bodov",
		"improveAccuracy": "zvýšiť presnosť pri priblížení (môže byť pomalšie)",
		"defaultFunctionParameters": "Predvolené parametre funkcií",
		"thickness": "Hrúbka",
		"drawDerivativeAndPrimitive": "Narysovať primitívnu funkciu a jej derivácie",
		"drawArea": "narysovať oblasť pod funkciou",
		"lineStyle": "Štýl čiary",
		"styleLine": "plná",
		"styleDotted": "bodkovaná",
		"styleDashed": "bodkočiarkovaná",
		"display3D": "Zobrazenie 3D",
		"displayStyle": "Style d'affichage",
		"styleSurfaces": "surfaces",
		"resetDisplay": "Obnoviť zobrazenie",
		"colorsConfig": "Konfigurácia farieb",
		"useRedFor": "použiť červenú na",
		"useGreenFor": "použiť zelenú na",
		"useBlueFor": "použiť modrú na",
		"positiveValues": "kladná hodnota",
		"negativeValues": "záporná hodnota",
		"always": "vždy",
		"globalValue": "Globálna hodnota",
		"globalValueRange": "(medzi 0 a 255)",
		"usage": "Použitie",
		"examples": "Príklady",
		"howItWorks": "Ako to funguje",
		"howItWorksText": "Táto aplikácia vám umožňuje zobraziť graf matematickej funkcie. Zadajte funkciu do poľa v hornej časti aplikácie a stlačte tlačidlo Zobraziť. Ak chcete upraviť túto funkciu alebo pridať novú, otvorte menu „Funkcie.“",
		"availableFunctionsText": "Môžete zadať tieto matematické funkcie:",
		"basicOperations": "Základné úkony",
		"plus": "sčítanie",
		"minus": "odčítanie",
		"multiplication": "násobenie",
		"division": "delenie",
		"modulus": "zvyšok pri delení",
		"trigonometricFunctions": "Trigonometrické funkcie",
		"sine": "sínus",
		"cosine": "kosínus",
		"tangent": "tangens",
		"cotangent": "kotangens",
		...
		"cosecant": "kosekans",
		"arcSine": "arkussínus",
		"arcCosine": "arkuskosínus",
		"arcTangent": "arkustangens",
		"arcCotangent": "arkuskotangens",
		"hyperbolicFunctions": "Hyperbolické funkcie",
		"hypSine": "hyperbolický sínus",
		"hypCosine": "hyperbolický kosínus",
		"hypTangent": "hyperbolický tangens",
		"hypCotangent": "hyperbolický kotangens",
		"hypSecant": "hyperbolický sekans",
		"hypCosecant": "hyperbolický kosekans",
		"hypArcSine": "hyperbolický arkussínus",
		"hypArcCosine": "hyperbolický arkuskosínus",
		"hypArcTangent": "hyperbolický arkustangens",
		"hypArcCotangent": "hyperbolický arkuskotangens",
		"powerAndRoot": "Mocniny a odmocniny",
		"squareRoot": "Druhá odmocnina",
		"power": "Mocniny",
		"xPowY": "x na y-tu",
		"root": "Odmocniny",
		"rootText": "y-ta odmocnina čísla x",
		"expAndLog": "Exponenciálne a logaritmické funkcie",
		"naturalLog": "prirodzený logaritmus",
		"decimalLog": "desiatkový logaritmus",
		"absValue": "absolútna hodnota",
		"rounding": "Zaokrúhľovanie",
		"roundText": "zaokrúhliť na najbližšie celé číslo",
		"ceilText": "zaokrúhliť nahor",
		"floorText": "zaokrúhliť nadol",
		"constants": "Konštanty",
		"keyboardShortcuts": "Klávesové skratky",
		"moveLeft": "posun naľavo",
		"moveTop": "posun nahor",
		"moveRight": "posun napravo",
		"moveBottom": "posun nadol",
		"examplesText": "(Môžete kliknúť na príklad a ten sa vám zobrazí. Ak je to potrebné, nezabudnite v možnostiach upraviť presnosť.)",
		"functions2d": "Funkcie 2D",
		"functions3d": "Funkcie 3D",
		"saveGraph": "Uložiť graf",
		"functionStudy": "Štúdium funkcie",
		"domainOfDefinition": "Definičný obor funkcie",
		"symmetry": "Parita",
		"zeros": "Nuly",
		"sign": "Znamienko",
		"asymptotes": "Asymptóty",
		"extremums": "Extrémy",
		"inflexionPoints": "Inflexné body",
		"functionStudyText": "Nástroj na analýzu funkcie nie je spoľahlivý na 100 %. Pred použitím výsledkov v praxi si ich nezabudnite skontrolovať. ",
		"history": "História",
		"newFunction": "Nová funkcia",
		"cartesian": "kartézska",
		"implicit": "implicitná",
		"polar": "polárna",
		"parametric": "paramatrická",
		"add": "Pridať",
		"functionsListText": "Zoznam funkcií",
		"edit": "Upraviť",
		"tools": "Nástroje",
		"from": "od",
		"to": "do",
		"color": "farba,
		"derivatives": "Derivácie",
		"primitive": "Primitívna funkcia",
		"duplicate": "Duplikovať",
		"remove": "Odsstrániť",
		"computePoint": "Vypočítať bod funkcie",
		"compute": "Vypočítať",
		"computeArea": "Vypočítať oblasť pod funkciou",
		"startStudy": "Preštudovať funkciu",
		"latestDisplayedFunctions": "Naposledy zobrazené funkcie",
		"chooseColor": "Výber farieb",
		"value": "Hodnota",
		...
		"oldColor": "Stará farba",
		"newColor": "Nová farba",
		"cancel": "Zrušiť",
		"error": "Chyba",
		"cannotDrawFunction": "Funkciu nie je možné zobraziť",
		"invalidExpression": "Neplatný výraz",
		"checkTheFunction": "Skontrolujte funkciu",
		"errorMessage": "Hlásenie o chybe",
		"youCanFindExamples": "Popis a príklady rôznych funkcií, ktoré môžete narysovať, nájdete v pomocníkovi",
		"width": "Šírka",
		"height": "Výška",
		"backgroundColor": "Farba pozadia",
		"imageFormat": "Formát obrázka",
		"update": "Aktualizovať",
		"currentVersion": "Súčasná verzia",
		"latestVersionAvailable": "Najnovšia dostupná verzia",
		"useLatestVersion": "Použiť najnovšiu verziu",
		"axes": "súradnicové osi",
		"scale": "číselná os",
		"grid": "mriežka",
		"reset": "Obnoviť",
		"saveImageTitle": "Uložiť obrázok",
		"saveImageText": "Kliknite pravým tlačidlom na obrázok a vyberte položku „Uložiť obrázok“. Môžete tiež vybrať položku „Kopírovať obrázok“ a potom ho vložiť do inej aplikácie.",
		...
		"none_m": "žiadny",
		"clickHereToModify": "Cliquez ici pour modifier les fonctions ou en ajouter une nouvelle.",
		"enterFunction": "Zadajte funkciu",
		"needHelp": "Potrebujete pomoc",
		"unableLoadParameters": "Nie je možné spustiť parametre..."
	}
